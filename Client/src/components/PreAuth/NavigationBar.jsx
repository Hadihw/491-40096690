    ...
    return (
        <header className={`header-transition z-50 flex fixed justify-center md:justify-between items-center w-full top-0 ${transformHeader ? 'bg-white text-gray-800 shadow-lg py-2' : 'text-white py-4'}`}>
            ...
            <nav className="hidden md:flex space-x-6">
                <a onClick={() => navigateToPath('/')} className={`${transformHeader ? 'text-black border-transparent hover:opacity-80 hover:border-black' : 'text-black border-transparent hover:opacity-80 hover:border-light'} border-b-2 cursor-pointer font-axiom`}>Home</a>
                <a onClick={() => navigateToPath('/about')} className={`${transformHeader ? 'text-black border-transparent hover:opacity-80 hover:border-black' : 'text-black border-transparent hover:opacity-80 hover:border-light'} border-b-2 cursor-pointer font-axiom `}>About</a>
                <a onClick={() => navigateToPath('/faqs')} className={`${transformHeader ? 'text-black border-transparent hover:opacity-80 hover:border-black' : 'text-black border-transparent hover:opacity-80 hover:border-light'} border-b-2 cursor-pointer font-axiom `}>FAQs</a>
                <a onClick={() => navigateToPath('/contactus')} className={`${transformHeader ? 'text-black border-transparent hover:opacity-80 hover:border-black' : 'text-black border-transparent hover:opacity-80 hover:border-light'} border-b-2 cursor-pointer font-axiom `}>Contact Us</a>
            </nav>
