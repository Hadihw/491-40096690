    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.status === 201) {
                //Successful registration => redirect to dashboard/home
                navigate("/Login", {
                    state: {
                        email: email,
                        registrationSuccess: true
            ...
            <div className="w-full flex-grow flex justify-center">
                <div className="w-full">
                    <img onClick={() => {
                        navigate("/");
                         ...
                         className="mx-auto h-20 w-auto mb-10 cursor-pointer" src="/assets/images/logo(500x500).png" alt="Muscles University" />
                    ...
                    <form className="mt-8 space-y-6" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div className="lg:w-1/4 m-auto space-y-4">
                            <button onClick={handleGoogleRegister}
                                    className="mt-4 m-auto font-axiom group relative flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  <img src={googleLogo} alt="Google Logo" className="h-5 w-5"/>
                            ...
                            <button type="submit"
                                    className="m-auto font-axiom group relative flex w-full justify-center rounded-md border border-transparent bg-dark py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-dark-500 focus:ring-offset-2">
                                Register
                            </button>
