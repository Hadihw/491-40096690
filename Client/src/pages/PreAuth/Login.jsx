            ...
            <div className="w-full max-w-md space-y-8">
                <div>
                    <img
                        ...
                        className="mx-auto h-20 w-auto mb-10 cursor-pointer"
          ...
          <img src={googleLogo} alt="Google Logo" className="h-5 w-5" />
                    ...
                    <div>
                        <Link to="/register">
                            <button
                                type="submit"
                                className="font-axiom group relative flex w-full justify-center rounded-md border
            border-transparent bg-medium py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                style={{
                                    boxShadow: '0 -1px 0 rgba(0, 0, 0, .04), 0 1px 1px rgba(0, 0, 0, .25)',
                                    backgroundPosition: '12px 11px',
                                    backgroundRepeat: 'no-repeat',
